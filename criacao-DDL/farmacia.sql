...
-- -----------------------------------------------------
-- Table `farmacia`.`produto_compra`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `farmacia`.`produto_compra` ;

CREATE TABLE IF NOT EXISTS `farmacia`.`produto_compra` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `id_produto` INT NOT NULL,
  `id_compra` INT NOT NULL,
  `quantidade` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_produto_compra_1_idx` (`id_produto` ASC),
  INDEX `fk_produto_compra_2_idx` (`id_compra` ASC),
  CONSTRAINT `fk_produto_compra_1`
    FOREIGN KEY (`id_produto`)
    REFERENCES `farmacia`.`produtos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_produto_compra_2`
...
CREATE TABLE IF NOT EXISTS `farmacia`.`receitas_medica` (
  ...
  CONSTRAINT `fk_receitas_medica_1`
    ...
    REFERENCES `farmacia`.`produto_compra` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
